...
plot_subpop_rt <- get_plot_subpop_rt(draws_df$site_level_rt, forecast_date)
plot_subpop_rt
```
...
```r
plot(draws_df, what = "predicted_ww")
plot(draws_df, what = "global_rt")
plot(draws_df, what = "site_level_rt")
```
