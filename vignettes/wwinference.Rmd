...
```
<div class="figure">
<img src="figures/getting-started-hosp-forecasts.png" alt="plot of wastewater-informed forecast of hospital admissions" width="100%" />
<p class="caption">plot of wastewater-informed forecast of hospital admissions</p>
</div>
...
```
<div class="figure">
<img src="figures/getting-started-ww-conc.png" alt="plot of fit and forecasted wastewater concentrations" width="100%" />
<p class="caption">plot of fit and forecasted wastewater concentrations</p>
</div>
```{r}
...
```
<div class="figure">
<img src="figures/getting-started-global-rt.png" alt="plot of global R(t) estimate" width="100%" />
<p class="caption">plot of global R(t) estimate</p>
</div>
```{r}
...
```
<div class="figure">
<img src="figures/getting-started-subpop-rt.png" alt="plot of subpopulation level R(t) estimates" width="100%" />
<p class="caption">plot of subpopulation level R(t) estimates</p>
</div>
...
```
<div class="figure">
<img src="figures/getting-started-hosp-forecasts-hosp-only.png" alt="plot of forecasted hospital admissions fit only to hospital admissions" width="100%" />
<p class="caption">plot of forecasted hospital admissions fit only to hospital admissions</p>
</div>
