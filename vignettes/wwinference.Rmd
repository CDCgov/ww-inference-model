...
(`stan_data_args`), and the list of the MCMC options (`mcmc_options`) passed to
...
convergence_flag_df <- get_model_diagnostic_flags(
  stan_fit_obj = ww_fit$fit$result,
  ebmfi_tolerance = 0.2,
...
# Get the tables using the CmdStan functions directly
