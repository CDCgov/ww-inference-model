...
| Infection feedback term | $\gamma \sim \mathrm{logNormal}(4.50, 0.64)$ | Weakly informative prior chosen to have a mode of 90 in natural scale, based on posterior estimates of the infection feedback from model fits from March 2023 to March 2024 in Alaska, Massachusetts, New Jersey, New Hampshire, and Washington |
